...
echo ===================================================
echo   Antigravity App Launcher (Windows)
echo ===================================================
echo.
...
set "ENTRY_POINT="
if exist "simple_notepad.py" set "ENTRY_POINT=simple_notepad.py"
...
if not defined ENTRY_POINT (
    echo [ERROR] Python entry point (simple_notepad.py / app.py / main.py / src\app.py) not found.
    echo.
    pause
    exit /b 1
)
